...
this;
#tracing1.on(CHANGE, ($display, $data) => {
    this;
    #tracing2.setData($data);
});
this;
#tracing2.on(CHANGE, ($display, $data) => {
    this;
    #tracing1.setData($data);
});
this;
#tracing1.on("COMPLETE", ($display, $curValue) => {
    if ($curValue.mode == 0) {
        if ($curValue.value == 0) {
            this;
            #label1.text = "未完成";
...
;
this;
#tracing2.on("COMPLETE", ($display, $curValue) => {
    if ($curValue.mode == 0) {
        if ($curValue.value == 0) {
            this;
            #label2.text = "未完成";
