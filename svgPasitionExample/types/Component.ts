...
export namespace gui {
    ...
    export interface PathGraphics extends Base, DisplayComponent {
    ...
    export interface Arrow extends Base, DisplayComponent {
        type: guiType.Arrow,
        lineWidth?: number,
        radius?: number,
        lineColor?: number,
    ...
    export interface Star extends Base, DisplayComponent {
        type: guiType.Star,
        lineWidth?: number,
        lineColor?: number,
        triangleNum?: number,
    ...
    export interface SVGPasition extends Base, DisplayComponent {
    ...
    export type AllGUI = gui.Button | gui.Custom | gui.Text | gui.Image | gui.Checkbox |
        ...
        gui.FollowLine | gui.ConnectLine | gui.Slider | gui.TextInput | gui.Audio | gui.Star | gui.Arrow | gui.PathGraphics
}
