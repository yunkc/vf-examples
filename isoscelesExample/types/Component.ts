...
export namespace gui {
    ...
    export interface Isosceles extends Base, DisplayComponent {
    ...
    export type AllGUI = gui.Button | gui.Custom | gui.Text | gui.Image | gui.Checkbox |
        ...
        gui.FollowLine | gui.ConnectLine | gui.Slider | gui.TextInput | gui.Audio | gui.Star | gui.Arrow | gui.Isosceles
}
