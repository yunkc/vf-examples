...
import { AssetType } from "./IVFTemplate";
...
export namespace gui {
    ...
    export interface Tracing extends Base, DisplayComponent {
        type: guiType.Tracing,
        debug: boolean,
        mode:number,
        traceSprite: string|number,
        renderBgSprite: string|number,
        tracePoints:{ x: number; y: number; }[][],
        lineTexture:string|number,
    }

    export interface Spine extends Base, DisplayComponent {
        type: guiType.Spine,
        ske_json: number,
        ske_atlas: number,
        ske_tex: number,
    ...
    export type AllGUI = gui.Button | gui.Custom | gui.Text | gui.Image | gui.Checkbox |
                         ...
                         gui.ScrollBar  | gui.Audio | gui.Tracing
}
